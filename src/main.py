...
screen_w = int(infoObject.current_w / 0.2)
screen_h = int(infoObject.current_w / 0.2)
...
while running:
    ...
    for b1 in bars:
        for b in b1:
            ...
            # Use only the outer point (point3) to remove arrow shapes
            point3 = (int(b.rect.points[3][0]), int(b.rect.points[3][1]))  # Outer tip of the bar
            poly.append(point3)
